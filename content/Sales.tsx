...
const saleTimes:SaleEvent[] = [
  ...
  { date: '2023-04-17', description: 'Pönkeliständi, Osakuntasalin edusta, Rehtorinpellonkatu 4', time: '12.00 - 16.00' },
  { date: '2023-04-18', description: 'Pönkeliständi, Osakuntasalin edusta, Rehtorinpellonkatu 4', time: '14.00 - 18.00' },
  ...
  { date: '2023-04-30', description: 'Pönkeli jalkatuu ympäri Turun keskustaa klo 13.00 alkaen', time: '13.00->' },
  { date: '2023-05-01', description: 'Teekkarikaste & Wappupiknik klo 12.00, Itäinen Rantakatu 48 & Vartiovuori', time: '12.00->' },
]
